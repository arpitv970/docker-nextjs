const UserInfoForm = () => {
  ...
  <form className='flex flex-col mt-5 outline-dashed outline-offset-[2px] rounded-2xl border-0 border-white px-5 py-3 w-[70%]'>
      ...
      <input className='text-black px-4 py-2 rounded-xl mb-3' placeholder='Enter DoB' type='date' name='dob' id='dob' requried />
	
      <lable for='phone'>Phone Number:</lable>
      <input className='text-black px-4 py-2 rounded-xl mb-3' placeholder='Enter Valid Phone Number' type='text' name='phone' id='phone' requried />
  </form>
